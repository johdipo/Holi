...
| 2026-04-09 | PRODUCT-V1-DESIGN.md + SOURCE-REGISTRY.yaml + DECISION-LOG.md + ASSUMPTIONS.md + OPEN-QUESTIONS.md | Locked V1 product scope (onboarding/QCM, collaborative swipe, planning+travel modes, bounded chatbot), added kill-list and new claims C-121..C-123, updated assumptions/questions | Complete TASK-131 with explicit MVP journey, core loop and anti-overbuild guardrails | Ops Hub TASK-131 | Unblocks monetization (TASK-132) and feasibility (TASK-133) with a concrete product baseline |
